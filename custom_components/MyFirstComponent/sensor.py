...
#START YAML Defines how the configuration.yaml will look like. The part 'repositories' will have additional suboptions path and name.
...
#START SETUP_PLATFORM Homeassistant will look for the function setup_platform or async_setup_platform in the sensor file.
